...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/aboutpage.css') }}">
    ...
    <body>
        ...
        <div class="head">
            <div class="container">
            <div class="head-left">
                <b><a href="{{ route('home.page') }}" class="text-decoration-none text-white">Stock+</a></b>
            </div>
            <div class="head-right">
                <b><a href="{{ route('home.page') }}" class="text-decoration-none text-white">Home</a></b>
                <a href="#" class="text-decoration-none text-white">About&nbsp</a> |
                <a href="#" class="text-decoration-none text-white"><i class="fas fa-search"></i></a>
                <a href="#" class="text-decoration-none text-white"><i class="fas fa-shopping-cart"></i></a>
                <a href="#" class="text-decoration-none text-white" onclick="openModal()"><i class="fas fa-user"></i></a>
            </div>
            </div>
        </div>
            ...
            <div class="footer-container">
              <div class="footer-content">
                ...
                <div class="footer-column">
                  ...
                  <p>Join us at the upcoming industry conference.</p>
                  <p>Learn about the latest trends in storage solutions.</p>
                </div>
                <div class="footer-column">
